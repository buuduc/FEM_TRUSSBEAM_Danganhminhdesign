...
if size(elem,2)==11
    for i=1:size(elem,1) % ve luc doc truc
        [x1,y1]=posnos(elem(i,1));
        [x2,y2]=posnos(elem(i,2));
        ...
        switch elem(i,11) 
            case 1
                plot(XX,YY,'s','markersize',10,'color',[1 0 0],'linewidth',4);
            case 3
                plot(XX,YY,'o','markersize',10,'color',[0 1 0],'linewidth',4);
            case 2 
                plot(XX,YY,'-.','markersize',10,'color',[0 1 0],'linewidth',4);
        end
        hold on
    end
end
